/**
 * MATE2018_OBS
 * Code provided by MATE that runs on the OBS during the competition.
 * This file is more of an example of how to use the AT commands than anything else. It programs the Arduino to 
 *  control the ESP to establish a wireless access point, setup a website that displays voltage, and angle data.
 * See the Prop Building Instructions for 2018 for more details. 
 */
